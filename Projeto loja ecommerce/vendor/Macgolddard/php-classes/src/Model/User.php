...
namespace Macgolddard\Model;

use \Macgolddard\DB\Sql;
use Macgolddard\Mailer;
...
class User extends Model
{
    ...
    //Nome da sessão do usuario
    const SESSION = "User";
    const SECRET = "MacgolddardPHP7_Secret";
    ...
    public static function getForgot($email, $inadmin = true)
    {
        ...
        if (count($res) === 0) {
            ...
            if (count($results) === 0) {
                ...
                if ($inadmin === true) {
                    $link = "http://ecommerce.vss/admin/forgot/reset?code=$result";
                } else {
                    $link = "http://ecommerce.vss/forgot/reset?code=$result";
                }
